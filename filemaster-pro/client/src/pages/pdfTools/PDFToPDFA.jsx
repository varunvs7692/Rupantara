...
export default function PDFToPDFA() {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(data.error || 'Failed to convert PDF to PDF/A');
      }
  ...
  return (
    <div className="max-w-lg mx-auto p-8">
      <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-white">PDF to PDF/A</h2>
      ...
      {downloadUrl && (
        <a href={downloadUrl} download className="block mt-4 text-green-600">Download PDF/A</a>
      )}
